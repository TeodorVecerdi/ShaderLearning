...
public class RaytracingBasic : MonoBehaviour {
    ...
    private float oldSkyboxRotation;
    ...
    private void Awake() {
        ...
        oldSkyboxRotation = SkyboxRotation;
    ...
    private void Update() {
        ...
        if (Math.Abs(oldSkyboxRotation - SkyboxRotation) > 0.01f) {
            oldSkyboxRotation = SkyboxRotation;
            currentSample = 0;
        }
    ...
    private void SetShaderParameters() {
        ...
        RaytracingShader.SetFloat("SkyboxRotation", SkyboxRotation);
